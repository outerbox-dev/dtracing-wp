...
/***/ "./src/javascript/components/select-vehicle-form.js":
/*!**********************************************************!*\
  !*** ./src/javascript/components/select-vehicle-form.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  /* harmony export */   SelectVehicleForm: () => (/* binding */ SelectVehicleForm)
  /* harmony export */ });
  class SelectVehicleForm {
    constructor( element ) {
  ...
  /*!********************************!*\
    ...
    \********************************/
  __webpack_require__.r(__webpack_exports__);
  /* harmony import */ var _components_select_vehicle_form__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/select-vehicle-form */ "./src/javascript/components/select-vehicle-form.js");
  ...
  jQuery( document ).ready( () => {
    ...
    if ( selectVehicleForms.length > 0 ) {
      selectVehicleForms.forEach( selectVehicleForm => {
        new _components_select_vehicle_form__WEBPACK_IMPORTED_MODULE_0__.SelectVehicleForm( selectVehicleForm );
      } );
    }
  } );
